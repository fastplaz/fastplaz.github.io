    ...
    return (
      <SplashContainer>
        ...
        <div className="inner">
          ...
          <PromoSection>
            <Button href="#featured">Featured</Button>
            <Button href="#themeTemplate">Template Engine</Button>
            <Button href={docUrl('orm')}>ORM</Button>
          </PromoSection>
        </div>
      </SplashContainer>
    );
...
class Index extends React.Component {
  render() {
    ...
    const LearnHow = () => (
      <Block id="themeTemplate" background="light">
        {[
          {
            content:
              'Each new FastPlaz project has **featured** theme template. <br>[FastPlaz Theme Engine](/docs/fte) will make the world happy.',
            image: `${baseUrl}img/undraw_youtube_tutorial.svg`,
            imageAlign: 'right',
            title: 'Featured Theme Template',
          },
        ]}
      </Block>
    );
    ...
    const Features = () => (
      <Block id="featured" layout="fourColumn">
        {[
          {
          ...
          },
          {
            ...
            image: `${baseUrl}img/home/multi.png`,
            imageAlign: 'top',
